...
class Blip2Vicuna(Blip2Base):
    """
    BLIP2 Vicuna model (Before Instruction Finetuning).
    Supported model types:
        - vicuna7b
        - vicuna13b
    Usage:
        >>> from lavis.models import load_model
        >>> model = load_model("blip2_vicuna", "vicuna7b")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "vicuna7b": "configs/models/blip2/blip2_vicuna7b.yaml",
        "vicuna13b": "configs/models/blip2/blip2_vicuna13b.yaml",
    }
    ...
    def __init__(
        ...
        qformer_text_input=False, # Important to set to False!
    ):
        super().__init__()
