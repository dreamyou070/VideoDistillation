...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with torch.no_grad():
                teacher_model_pred = teacher_unet(noise, timesteps, encoder_hidden_states).sample
                if args.motion_control:
            ...
            student_model_pred = student_unet(noise, timesteps, encoder_hidden_states).sample
            if args.motion_control:
            ...
            total_loss = args.distill_weight * loss_distill
            if args.motion_control:
                total_loss = args.distill_weight * loss_distill + args.loss_feature_weight * loss_feature
                if args.do_attention_map_check:
